...
It renames all the occurrences of Zbot (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the Zbot folder
        os.rename(
            os.path.join(root_dir_path, "exts", "Zbot", "Zbot"),
            os.path.join(root_dir_path, "exts", "Zbot", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "Zbot"), os.path.join(root_dir_path, "exts", new_name))
